...
namespace Xamarin.ExposureNotifications
{
	public static partial class ExposureNotification
	{
		...
		static Task<(ExposureDetectionSummary, IEnumerable<ExposureInfo>)> PlatformDetectExposuresAsync(IEnumerable<TemporaryExposureKey> diagnosisKeys, string token, CancellationToken cancellationToken)
			=> throw new PlatformNotSupportedException();
